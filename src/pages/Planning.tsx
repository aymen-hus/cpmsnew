...
function Planning() {
  ...
  // Function to fetch complete plan data for preview
    ...
    try {
      ...
      const enrichedObjectives = await Promise.all(
        objectivesList.map(async (objective) => {
          try {
            // Get ALL initiatives and filter by this objective
            ...
            const objectiveInitiatives = allInitiatives.filter(initiative => {
            ...
            console.log(`After org filtering: ${filteredInitiatives.length} initiatives for objective ${objective.id}`);
            ...
            console.log(`Objective ${objective.id} FINAL: ${enrichedInitiatives.length} initiatives`);
      ...
      console.log(`TOTAL: ${totalInitiatives} initiatives across ${enrichedObjectives.length} objectives`);
