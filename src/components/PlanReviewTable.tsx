...
// Export the fetchCompleteData function so it can be reused
export const fetchCompleteData = async (objectivesList: any[], userOrgId: number | null) => {
...
// Export the productionSafeAPI as well
export { productionSafeAPI };
